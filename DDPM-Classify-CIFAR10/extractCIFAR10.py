...
save_to = "../../datasets/Generated/BaseCIFAR10"
...
for i in range(10):
    ...
    for index, (img, label) in enumerate(dataset):
        ...
        im.save(os.path.join(save_path, f"{str(index * 2).zfill(6)}.jpg"))
        im = im.transpose(Image.FLIP_LEFT_RIGHT)
        im.save(os.path.join(save_path, f"{str(index * 2 + 1).zfill(6)}.jpg"))
